...
(measurement.MeasurandValue as MeasurandValueBrix 
  ...
  INNER JOIN dbo.MeasurandConfig AS dboMeasurandConfigBrix ON (MeasurandConfigBrix.dboMeasurandConfigID=dboMeasurandConfigBrix.ID AND dboMeasurandConfigBrix.measurandID = 4) -- brix
...
WHERE MeasurementType.code IN (0,1,2,16) --- for codes execute SELECT query to dbo.MeasurementType Table
